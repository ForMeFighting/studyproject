...
/**
 * @Auther: 柴俊杰
 * @Description: 代码生成器，主要用于生成实体类和mapper.xml文件
...
public class CodeGenerator {
	...
	public void run() {
		...
		gc.setOutputDir("E:\\myselfProject\\study\\onlineedu\\service\\service-edu" + "/src/main/java");
